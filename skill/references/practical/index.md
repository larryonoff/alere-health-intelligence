...
Open only the practical files relevant to the request. Never load
`../knowledge/archive/` during normal user assistance.
...
1. Open `recipe-index.md`.
2. Select a reviewed recipe ID.
3. Open only its file under `recipes/`.
...
- `constructors/bowl.md`
- `constructors/cream-soup.md`

## Menu and shopping

- `planning/flexible-seven-day-menu.md` — adaptable example
  connected to reviewed recipe IDs.
- `planning/shopping-list-template.md` — rules for producing a
  contextual shopping list without invented quantities.

## Poland localization

- `localization/poland-ingredients.md` — Russian and Polish
